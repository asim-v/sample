var module_36946591725 = function() {
    var __hs_messages = {};
    ...
    var menuLinks = document.querySelectorAll(".submenu > li .menu-link"),
        firstSubmenuItems = document.querySelectorAll(".submenu.level-2 > *:nth-child(2)");
    menuLinks.forEach((function(link) {
        if (link.addEventListener("focus", (function() {
        ...
        window.hsInEditor || item && (item.addEventListener("mouseover", (function() {
